...
from core.utils import (
    ...
    get_random_description, notify_intervention
)
...
import threading
from services.telegram_service import start_telegram_bot, send_video_notification
...
if __name__ == "__main__":
    ...
    upload_script = os.path.join(config.BASE_DIR, "automation", "upload_scheduler.py")
    os.system(f'start "TIKTOK UPLOAD" {sys.executable} "{upload_script}"')
