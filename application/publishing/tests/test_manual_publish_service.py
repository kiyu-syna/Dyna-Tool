...
from application.publishing.extension_upload_service import LOCAL_SOURCE_KEY, ExtensionUploadService
...
class ManualPublishServiceTests(unittest.TestCase):
    ...
    def test_submit_creates_one_job_per_file_and_profile(self):
        ...
        self.assertEqual(first.batch_id, result["batch_id"])
        self.assertEqual(first.batch_name, "Lô game tháng 7")
        self.assertEqual(second.batch_name, "Lô game tháng 7")
        self.assertEqual(result["batch_name"], "Lô game tháng 7")
