...
DEFAULT_HISTORY_PATH = str(state_dir() / "activity_history.sqlite3")
    ...
    def record_event(
        ...
        *,
        ...
        try:
            ...
            _LOGGER.warning("Không thể ghi lịch sử hoạt động: %s", exc)
    ...
    def prune(self, retention_days: int = 90, now: datetime | None = None) -> int:
        ...
        if removed:
            try:
                ...
                _LOGGER.warning("Không thể thu gọn lịch sử hoạt động: %s", exc)
        return removed
