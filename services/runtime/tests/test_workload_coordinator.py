...
from services.runtime.workload_coordinator import PriorityResourcePool, priority_for_job
...
class WorkloadCoordinatorTests(unittest.TestCase):
    ...
    def test_waiters_are_admitted_by_priority(self):
        ...
        with patch("services.runtime.workload_coordinator.config.load_settings", return_value={"MAX_CONCURRENT_UPLOADS": 1}):
