...
import services.profile_diagnostics_service as diagnostics


class ProfileDiagnosticsServiceTests(unittest.TestCase):
    @patch("services.video_validation_service.resolve_ffprobe", return_value="ffprobe.exe")
    @patch("profile_automation.pipeline.profile_worker.check_douyin_direct_download")
    ...
    def test_diagnostics_return_structured_profile_results(
        ...
        load_profiles.return_value = {
            "2": {
                ...
                "douyin": {
                    ...
                    "sources": [{"target_sec_uid": "source", "enabled": True}],
                },
        ...
        direct_check.assert_called_once_with("22", api_url="http://127.0.0.1:1010")
    ...
    def test_profile_without_source_does_not_open_gemlogin(
        ...
        load_profiles.return_value = {
            "5": {"id": "5", "douyin": {"sources": []}}
        }

        with patch("profile_automation.pipeline.profile_worker.check_douyin_direct_download") as direct_check:
